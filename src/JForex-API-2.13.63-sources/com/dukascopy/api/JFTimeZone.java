 ...
 * <p> When calculating DataType.TIME_PERIOD_AGGREGATION candles, this time zone is used to shift two hour periods or larger
 * (larger means periods with unit Unit.Hour (if numOfUnits &ge; 2) or larger) candles according to time zone offset.
 * <p>Example:
