...
public final class Period implements Comparable<Period>, Serializable {
     ...
     * @throws ObjectStreamException should not be thrown
     */
     ...
     * @return standard time shift from GMT
     * @deprecated
	 */
	@Deprecated
	...
	public static boolean isTimeZoneValid(Unit unit, int numOfUnits, JFTimeZone timeZone) {
		if (timeZone.getReversedStandardOffset() != 0 || timeZone.getReversedDaylightOffset() != 0) {
			...
			if (Unit.Hour.getInterval() >= unit.getInterval() * numOfUnits) {
				return false;
			}
		}
		return true;
