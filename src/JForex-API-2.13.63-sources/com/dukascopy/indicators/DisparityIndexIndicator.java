...
public class DisparityIndexIndicator implements IIndicator {
    ...
    public void onStart(IIndicatorContext context) {
        indicatorInfo = new IndicatorInfo("DISP_INDEX", "Disparity Index", "", false, false, true, 1, 2, 1);
        ...
        optInputParameterInfos = new OptInputParameterInfo[] {
            new OptInputParameterInfo("Period", OptInputParameterInfo.Type.OTHER, new IntegerRangeDescription(13, 2, 2000, 1)),
    ...
    public IndicatorResult calculate(int startIndex, int endIndex) {
        ...
        for (int i = startIndex, j = 0; i <= endIndex; i++, j++) {
            outputs[0][j] = (inputs[0][i] - maOutput[j]) / maOutput[j] * 100;
        }
