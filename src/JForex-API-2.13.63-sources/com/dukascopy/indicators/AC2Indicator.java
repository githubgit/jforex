 ...
 * Date: Dec 18, 2009
 */
public class AC2Indicator implements IIndicator {
    ...
    public void onStart(IIndicatorContext context) {
        ...
        indicatorInfo = new IndicatorInfo("AC2", "Accelerator/Decelerator Oscillator", "Bill Williams", false, false, false, 1, 2, 1);
        ...
        optInputParameterInfos = new OptInputParameterInfo[] {
            new OptInputParameterInfo("Fast Period", OptInputParameterInfo.Type.OTHER,
                new IntegerRangeDescription(fastPeriod, 2, 100, 1)),
            new OptInputParameterInfo("Slow Period", OptInputParameterInfo.Type.OTHER,
                new IntegerRangeDescription(slowPeriod, 2, 100, 1))
        };
    ...
    public IndicatorResult calculate(int startIndex, int endIndex) {        
        ...
        for (i = 0, k = (dSMA3Result.getNumberOfElements()); i < k; i++) {            
            outputs[0][i] = aoShortened[i] - smaA3[i];
        }
